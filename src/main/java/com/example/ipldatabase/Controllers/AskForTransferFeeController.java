...
import com.example.ipldatabase.SecretData.SellRequest;
...
public class AskForTransferFeeController {
    ...
    public void confirmListing() throws IOException {
        ...
        transferLabel.setImage(new Image(Objects.requireNonNull(Main.class.getResourceAsStream("/com/example/ipldatabase/pic/virat.jpg"))));//Assets/Image/Stamp1.png
